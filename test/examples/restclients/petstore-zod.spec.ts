    ...
    it('addPet', async () => {
        await asyncForAll(arbitrary(Pet), async (pet) => {
            ...
            if ('right' in result) {
                ...
                expectTypeOf(result.error).toEqualTypeOf<ZodError<unknown> | ZodError<string> | undefined>()
                ...
                if (result.statusCode === '405') {
                    ...
                    expectTypeOf(result.headers).toEqualTypeOf<IncomingHttpHeaders>()
                    expectTypeOf(result.error).toEqualTypeOf<ZodError<unknown> | undefined>()
                ...
                if (result.where === 'response:body') {
                    ...
                    expectTypeOf(result.headers).toEqualTypeOf<IncomingHttpHeaders>()
                    expectTypeOf(result.error).toEqualTypeOf<ZodError<string> | undefined>()
...
describe('entities satisfy arbitrary', () => {
    it('Pet', () => {
        forAll(arbitrary(Pet), (x) => Pet.safeParse(x).success)
    })
    ...
    it('ApiResponse', () => {
        forAll(arbitrary(ApiResponse), (x) => ApiResponse.safeParse(x).success)
    })
    ...
    it('Order', () => {
        forAll(arbitrary(Order), (x) => Order.safeParse(x).success)
    })

    it('User', () => {
        forAll(arbitrary(User), (x) => User.safeParse(x).success)
    })

    it('CreateUsersWithListInputRequest', () => {
        forAll(arbitrary(CreateUsersWithListInputRequest), (x) => CreateUsersWithListInputRequest.safeParse(x).success)
    })
