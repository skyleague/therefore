...
export const recursion: Node = $array($ref(() => recursion)).validator({ type: 'zod' })

export const recursionObject: Node = $object({
    recursion: $array($ref(() => recursionObject)),
}).validator({ type: 'zod' })

export const recursionValidator: Node = $array($ref(() => recursionValidator)).validator({ type: 'zod' })
