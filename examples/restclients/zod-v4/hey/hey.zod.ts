...
export const DictionaryWithArray = z.record(z.string(), ModelWithString.array()).describe('This is a complex dictionary')
...
export const ModelWithOneOfEnum = z.union([
    ...
    z.object({
        content: z.iso.datetime({ offset: true }),
        foo: z.literal('Quux'),
    }),
    z.object({
        content: z.tuple([z.iso.datetime({ offset: true }), z.string()]),
        foo: z.literal('Corge'),
    }),
])
