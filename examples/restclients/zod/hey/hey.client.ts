    ...
    > {
        return this.awaitResponse(
            ...
            }),
            {
                ...
                500: { safeParse: (x: unknown) => ({ success: true, data: x }) },
            },
    ...
    > {
        return this.awaitResponse(
            ...
            }),
            {
                200: { safeParse: (x: unknown) => ({ success: true, data: x }) },
                500: { safeParse: (x: unknown) => ({ success: true, data: x }) },
                501: { safeParse: (x: unknown) => ({ success: true, data: x }) },
                502: { safeParse: (x: unknown) => ({ success: true, data: x }) },
                503: { safeParse: (x: unknown) => ({ success: true, data: x }) },
            },
